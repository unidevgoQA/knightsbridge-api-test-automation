...
@allure.step("Verify that the user can not get all coupon by put request")
def test_coupon_get_all_valid():
    ...
    result = coupon_api.put_request(payload=coupon_get_all_params, headers=admin_headers_with_token)
