...
@allure.step("Verify that the user can not get all coupon by post request")
def test_coupon_get_all_valid():
    ...
    result = coupon_api.post_request(payload=coupon_get_all_params, headers=admin_headers_with_token)
