...
@allure.step("Verify update wallet fail by user")
def test_update_wallet_user():
    ...
    result = update_api.put_request(payload=update_crypto_wallet_data, headers=headers_with_token)
